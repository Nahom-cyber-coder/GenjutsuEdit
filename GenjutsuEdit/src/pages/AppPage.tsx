      ...
      <Card className="backdrop-blur-lg bg-black/40 border-red-900/50 max-w-sm mx-4">
        <CardContent className="p-6 text-center">
          ...
          <h3 className="text-white text-lg font-semibold mb-2">
            <UchihaText uchihaText="Awaken Your Sharingan">Upload Your Image</UchihaText>
          </h3>
          ...
          >
            ...
            <UchihaText uchihaText="Activate Sharingan">Upload Photo</UchihaText>
          </Button>
        </CardContent>
      </Card>
    </motion.div>
        ...
        <div className="text-center space-y-4">
          ...
          <div className="bg-black/30 rounded-lg p-4 space-y-2">
            <p className="text-red-300 text-sm">
              🍃 <UchihaText uchihaText="Hidden Leaf Village Enthusiast">Boruto & Naruto Enthusiast</UchihaText>
            </p>
            <p className="text-red-300 text-sm">
              👁️ <UchihaText uchihaText="Follower of Itachi's Path">Itachi Uchiha Admirer</UchihaText>
            </p>
            <p className="text-red-300 text-sm">
              ⚡ <UchihaText uchihaText="Master of Sharingan Arts">Uchiha Clan Aesthetic</UchihaText>
            </p>
          </div>
            ...
            <div className="bg-red-900/20 border border-red-800 rounded-lg p-4">
              <p className="text-red-300 text-sm">
                🔥 <UchihaText uchihaText="Sharingan Language Mode Activated! Experience the power of the Uchiha through enhanced shinobi terminology.">
                  Uchiha Text Mode Active! Experience the power of the Sharingan through enhanced terminology.
                </UchihaText>
              </p>
            </div>
          )}
...
function AppPageContent() {
    ...
    if (!uploadedImage) {
      showErrorMessage(
        uchihaMode 
          ...
          : "Please upload an image first! You need to select a photo before you can use this tool."
      );
      return;
    }
  ...
  const tools = [
    {
      id: "upload",
      name: uchihaMode ? "Awaken Sharingan" : "Upload Photos",
      description: uchihaMode ? "Channel your chakra through photographs" : "Import your images and start your creative journey",
      icon: Upload,
      color: "from-red-500 to-red-700",
      action: uchihaMode ? "Activate" : "Upload",
      onClick: handleUploadClick,
    },
    {
      id: "cartoon",
    ...
    {
      id: "elastic",
      name: uchihaMode ? "Body Manipulation Jutsu" : "Elastic Photo",
        ...
        >
          ...
          <p className={`text-xl ${isDark ? 'text-gray-300' : 'text-red-200'} mb-8`}>
            <UchihaText uchihaText="Master the ancient art of visual genjutsu with legendary shinobi techniques">
              Master the art of visual illusion with powerful photo editing tools
            </UchihaText>
          </p>
        </motion.div>
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center p-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        ...
                        <UchihaText uchihaText="Dispel">Remove</UchihaText>
                      </Button>
                      <Button
                        variant="outline"
                        size="sm"
                  ...
                  >
                    ...
                    >
                      <CardHeader className="pb-3">
                        <div
                          className={`w-12 h-12 bg-gradient-to-r ${tool.color} rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}
                        >
          ...
          <Card className="backdrop-blur-lg bg-black/30 border-red-900/30">
            <CardContent className="p-6">
              <div className="flex flex-wrap justify-center gap-4">
                <Button
                  variant="ghost"
                  className={`${isDark ? 'text-white' : 'text-red-100'} hover:bg-red-900/20 flex items-center gap-2`}
                  onClick={handleUploadClick}
                >
                ...
                >
                  ...
                  <UchihaText uchihaText="Cast Genjutsu">Convert to Cartoon</UchihaText>
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="backdrop-blur-lg bg-black/30 border-red-900/30">
            <CardHeader>
              <CardTitle className={`${isDark ? 'text-white' : 'text-red-100'} text-center`}>
                🔥 <UchihaText uchihaText="Master Your Sharingan Vision">Master Your Creative Vision</UchihaText>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <h3 className={`${isDark ? 'text-white' : 'text-red-100'} font-semibold mb-2`}>
                    <UchihaText uchihaText="Awaken Your Sharingan">Upload Your Photo</UchihaText>
                  </h3>
                  <p className={`${isDark ? 'text-gray-300' : 'text-red-200'} text-sm`}>
                    <UchihaText uchihaText="Channel your chakra through photographs to begin the jutsu">
                      Import your images and begin your creative journey
                    </UchihaText>
                  </p>
                </div>
                <div>
                  ...
                  <h3 className={`${isDark ? 'text-white' : 'text-red-100'} font-semibold mb-2`}>
                    <UchihaText uchihaText="Select Your Technique">Choose Your Tool</UchihaText>
                  </h3>
                  <p className={`${isDark ? 'text-gray-300' : 'text-red-200'} text-sm`}>
                    <UchihaText uchihaText="Master various shinobi arts from our legendary arsenal">
                      Select from our professional editing suite
                    </UchihaText>
                  </p>
                </div>
                <div>
                  ...
                  <h3 className={`${isDark ? 'text-white' : 'text-red-100'} font-semibold mb-2`}>
                    <UchihaText uchihaText="Cast Your Genjutsu">Create Magic</UchihaText>
                  </h3>
                  <p className={`${isDark ? 'text-gray-300' : 'text-red-200'} text-sm`}>
